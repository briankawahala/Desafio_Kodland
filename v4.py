...
#movements
    ...
    for tile in list_plataforms:
        if (keyboard.up and hero.colliderect(tile) and not jumped()) or (keyboard.up and hero.colliderect(tile_1) and not jumped()) or (keyboard.up and hero.colliderect(tile_2) and not jumped()):
            gravity = 3
            hero.y -= 100
            jump = True
    for tile in list_plataforms:
